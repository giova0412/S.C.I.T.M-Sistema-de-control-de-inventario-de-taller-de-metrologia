            ...
            >
                <div className="p-4 flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="andform hover:scale-110 transition-all duration-500 text-white p-2 rounded hover:bg-pemex-dark-green"
                    >
                        {sidebarOpen ? "◄" : "►"}
                    </button>
                </div>
                ...
                <nav className="mt-8 space-y-2">
                    <div
                        ...
                        className="andform hover:bg-gray-500 transition-all duration-500 flex items-center px-4 py-3 text-white hover:bg-pemex-dark-green cursor-pointer"
                    >
            ...
            <main className={`${sidebarOpen ? "ml-64" : "ml-16"} transition-all duration-300`}>
                ...
                <div className="flex flex-col gap-2 shrink-0 sm:flex-row mt-4 m-5">
                    <button
                        ...
                        className="andform hover:scale-100 transition-all duration-500 flex select-none items-center gap-3 rounded-lg bg-pemex-green py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button"
                    >
                        <svg
                        ...
                        <div className="max-h-[90vh] overflow-auto w-full max-w-md rounded-lg bg-white p-6">
                            ...
                            <form onSubmit={handleEditSubmit} className="space-y-4">
                                <label className="block">
                                    ...
                                    <input
                                        type="text"
                                        value={editingReporte.nombre}
                                        onChange={(e) => setEditingReporte({ ...editingReporte, nombre: e.target.value })}
                                        className="andform w-full rounded border border-pemex-green px-3 py-2 text-sm text-gray-700"
                                        required
                                    />
                                </label>
                                ...
                                <label className="block">
                                    ...
                                    <input
                                        type="text"
                                        value={editingReporte.ficha}
                                        onChange={(e) => setEditingReporte({ ...editingReporte, ficha: e.target.value })}
                                        className="andform w-full rounded border border-pemex-green px-3 py-2 text-sm text-gray-700"
                                        required
                                    />
                                </label>
                                ...
                                <label className="block">
                                    <span className="text-pemex-green font-bold">Status</span>
                                    <select
                                        value={editingReporte.status}
                                        onChange={(e) => setEditingReporte({ ...editingReporte, status: e.target.value })}
                                        className="andform w-full rounded border border-pemex-green px-3 py-2 text-sm text-gray-700"
                                    >
                                        <option value="Pendiente">Pendiente</option>
                                        <option value="Entregado">Entregado</option>
                                ...
                                <label className="block">
                                    ...
                                    <input
                                        type="date"
                                        value={editingReporte.fechaEntregado}
                                        onChange={(e) => setEditingReporte({ ...editingReporte, fechaEntregado: e.target.value })}
                                        className="andform w-full rounded border border-pemex-green px-3 py-2 text-sm text-gray-700"
                                    />
                                </label>
                                ...
                                <label className="block">
                                    ...
                                    <input
                                        type="date"
                                        value={editingReporte.fechaRecibido}
                                        onChange={(e) => setEditingReporte({ ...editingReporte, fechaRecibido: e.target.value })}
                                        className="andform w-full rounded border border-pemex-green px-3 py-2 text-sm text-gray-700"
                                    />
                                </label>
