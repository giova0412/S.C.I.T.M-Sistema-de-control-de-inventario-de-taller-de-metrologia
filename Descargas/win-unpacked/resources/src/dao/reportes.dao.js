...
ReportesDAO.getAll = async () => {
    try {
        ...
        for (const reporte of reportesList) {
            ...
            // Mapear los nombres de todas las herramientas asociadas
            obj.nombres_herramientas = (reporte.id_herramienta || []).map(id => herramientasMap[id] || "Herramienta no encontrada");
            
            console.log(`Reporte ${reporte._id}: id_herramienta=${reporte.id_herramienta}, nombres_herramientas=${obj.nombres_herramientas.join(', ')}`);
